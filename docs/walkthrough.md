...
## Cristian - PC CASA - 2026-09-03
**Objetivo:** Agregar validación estricta al formato de CUIM (6 caracteres alfanuméricos, sin símbolos).
**Archivos modificados:**
- productos/models.py
- productos/views_trazabilidad.py
- verticalidades/armeria/views.py
**Detalle Técnico:** Se implementó una validación regex (^[A-Z0-9]{6}$) a nivel de controlador/vista para retornar mensajes amigables si el formato del CUIM es incorrecto. Además, se sobreescribió el método clean y save del modelo Subproducto garantizando la integridad de datos a nivel base.
**Estado:** Completado.
